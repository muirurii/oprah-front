    ...
    <InView triggerOnce={true}>
      <section
        ...
        className={`py-12 relative after:absolute after:w-[1px] after:bottom-0 after:-left-4 after:rounded-full after:top-0 after:bg-secondary mb-12
                after:transition-all after:duration-1000 after:origin-top ${
                  inView ? "after:scale-100" : "after:scale-0"
                }`}
      >
        ...
        <div
          className={`absolute -bottom-12 -left-10 h-12 w-12 rounded-full
